...
<div id="templatemo_container">
  ...
  $resulta = mysql_query("SELECT * FROM beverage_members WHERE id = '$id'");
  ...
  <div id="templatemo_content">
    <div id="templatemo_content_left">
      ...
      echo '<div class="templatemo_pizza_box"> <a rel="facebox" href=portal.php?id=' . $row3["product_id"] . '><img alt="Pizza" src="images/drinks/'.$row3['product_photo'].'" width="65px" height="65px" /></a>';
