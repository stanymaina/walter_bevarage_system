...
mysql_query("INSERT INTO beverage_orders (cusid, amountpaid, status, transactiondate, transactioncode, mode) VALUES('$cusid', '$grandtotal', '$status', '$trasactiondate', '$transactioncode', '$mode')");
?> 
...
<div align="center"><img src="images/png" /></div><br /><br />
...
include('config.php');
$memid=$_POST['cusid'];
$result = mysql_query("SELECT * FROM beverage_members where id = '$memid'");
...
<br /><br />
<div align="center">
THIS IS SERVE AS YOUR OFFICIAL RECEIPT<BR />THANK YOU FOR CHOOSING BEVERAGE ORDERING SYSTEM<BR />OPTIONAL FOR PRINTING<br>NOTE: Expect a phone call confirmation before the delivery
</div>
</div>
</body>
</html>