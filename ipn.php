...
$trasactiondate=date("m/d/Y");
            ...
            ($payment_currency == "PHP") ) { //txn_id isn't same as previous to stop duplicate payments. You will need to write a function to do this check.
                ...
                mysql_query("INSERT INTO beverage_orders(cusid, amountpaid, status, transactiondate, transactioncode, mode)VALUES('$item_name', '$payment_amount', '$payment_status1', '$trasactiondate', '$item_number', '$mode')");
